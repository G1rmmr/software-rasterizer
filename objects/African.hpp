...
public:
    inline void Create() override {
        ...
        this->Meshes.push_back(graphics::Mesh{
            ...
            std::make_shared<graphics::Texture>("assets/african/african_head_nm_tangent.tga", true),
            std::make_shared<graphics::Texture>("assets/african/african_head_spec.tga", true), nullptr, nullptr,
        ...
        this->Meshes.push_back(graphics::Mesh{
            innerVertices, innerIndices,
            std::make_shared<graphics::Texture>("assets/african/african_head_eye_inner_diffuse.tga"),
            std::make_shared<graphics::Texture>("assets/african/african_head_eye_inner_nm_tangent.tga", true),
            std::make_shared<graphics::Texture>("assets/african/african_head_eye_inner_spec.tga", true), nullptr,
            nullptr, nullptr});
        ...
        this->Meshes.push_back(graphics::Mesh{
            ...
            std::make_shared<graphics::Texture>("assets/african/african_head_eye_outer_nm_tangent.tga", true),
            std::make_shared<graphics::Texture>("assets/african/african_head_eye_outer_spec.tga", true),
            std::make_shared<graphics::Texture>("assets/african/african_head_eye_outer_gloss.tga", true), nullptr,
            nullptr});
    }
};